namespace EventHubPublisher
{
	...
	{
		private const string EventHubConnectionString = "**********"; // ie Endpoint=sb://XXX.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=XXX
